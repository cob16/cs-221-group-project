...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public final static String RECORD_COLUMN_time = "time";

	private static final String DATABASE_NAME = "topkek";
	public static final int DATABASE_VERSION = 1;

	// Database creation sql statement
	private final String DATABASE_CREATE = "create table " + TABLE_RESERVES
			+ "(" + COLUMN_ID + " integer primary key autoincrement, "
			+ COLUMN_NAME + " text not null);";

	private final String MAKE_Species = "create table " + TABLE_SPECIES + "("
			+ SPECIES_COLUMN_ID + " integer primary key autoincrement, "
			+ SPECIES_COLUMN_NAME + " text not null);";

	private final String MAKE_Records = "CREATE TABLE " + TABLE_RECORDS
			+ "(" + RECORD_COLUMN_ID + " integer primary key autoincrement, "
			+ RECORD_COLUMN_species + " text NOT NULL, " + RECORD_COLUMN_DAFOR
			+ " char NOT NULL, "
			+ RECORD_COLUMN_comments + " text, " + RECORD_COLUMN_date_recorded
			+ " date NOT NULL, " + RECORD_COLUMN_photo_path_general
			+ " text NOT NULL, " + RECORD_COLUMN_photo_path_species
			+ " text NOT NULL, " + RECORD_COLUMN_reserve_name
			+ " text NOT NULL, "
			+ RECORD_COLUMN_location + " TEXT NOT NULL);";
	...
	public void onCreate(SQLiteDatabase database) {
		database.execSQL(DATABASE_CREATE);// + MAKE_Records + MAKE_Species);
